  ...
  <div class="wrapper">
    <div class="bg-gradasi m-3 p-3 container row align-items-center uhuy zoom" style="border-radius: 20px;">
      ...
      <div class="col-md-5 margin-start">
        <h1 class="" style="color: white; font-size: 36px; font-weight: 600;">Implementasi Metode <br> K-Means Clustering </h1>
        <p class="text-wrap" style="color: white;">Untuk Pengelompokan Judul Skripsi <br> Mahasiswa Studi Kasus: STMIK Widya Cipta Dharma</p>
      ...
      <div class="col-md-6 text-center uhuy zoom">
        <div style="position: relative;">
          ...
          <h1 style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 10vw; font-weight: 600; color: white;">{{ count }}</h1>
        </div>
      </div>
